import {
  ...
  const CreatePassword = () => {const colorScheme = useColorScheme();
    return (
      <View style={styles.container}>
        ...
        <SafeAreaView style={styles.body}>
          ...
          >
            ...
            >
                Create a password with at least 8 characters including a number and a lowercase letter. it shouldn't be too similar to your other personal information.
            </Text>
            {/* form */}
            {/* input group */}
            <View
